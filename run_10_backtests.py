#!/usr/bin/env python3
"""
Run 3 Consecutive Backtests to Demonstrate RL/ML Learning
This script runs backtests back-to-back to show the bot's RL brain
is learning and accumulating experiences properly.
"""
...
def main():
    """Run 10 backtests and track learning progress"""
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('logs/multi_backtest.log'),
    ...
    logger.info("="*80)
    logger.info("RUNNING 3 CONSECUTIVE BACKTESTS")
    logger.info("="*80)
    ...
    # Run 3 backtests for demonstration
    num_runs = 3
    ...
    logger.info("")
    logger.info("="*80)
    logger.info(f"ALL {num_runs} BACKTESTS COMPLETE - FINAL SUMMARY")
    logger.info("="*80)
...
if __name__ == "__main__":
    try:
        ...
        if results:
            ...
            print(f"✓ Total experience growth demonstrated")
        else:
